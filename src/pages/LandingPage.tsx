    ...
    >
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="relative grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          {(
            [
              { step: 1, titleKey: 'landing.howit_step1_title', bodyKey: 'landing.howit_step1_body', color: 'text-cyan-600 dark:text-cyan-300', bg: 'bg-cyan-400/10 border-cyan-400/25' },
              { step: 2, titleKey: 'landing.howit_step2_title', bodyKey: 'landing.howit_step2_body', color: 'text-violet-600 dark:text-violet-300', bg: 'bg-violet-400/10 border-violet-400/25' },
              { step: 3, titleKey: 'landing.howit_step3_title', bodyKey: 'landing.howit_step3_body', color: 'text-emerald-600 dark:text-emerald-300', bg: 'bg-emerald-400/10 border-emerald-400/25' },
              { step: 4, titleKey: 'landing.howit_step4_title', bodyKey: 'landing.howit_step4_body', color: 'text-blue-600 dark:text-blue-300', bg: 'bg-blue-400/10 border-blue-400/25' },
            ] as const
          ).map((s) => (
            <div
              key={s.step}
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {(
            [
              { icon: TrendingUp, titleKey: 'landing.role_owner_title', bodyKey: 'landing.role_owner_body', iconColor: 'text-cyan-600 dark:text-cyan-300', iconBg: 'bg-cyan-400/10 border-cyan-400/20', hoverBorder: 'hover:border-cyan-400/30' },
              { icon: Users, titleKey: 'landing.role_manager_title', bodyKey: 'landing.role_manager_body', iconColor: 'text-violet-600 dark:text-violet-300', iconBg: 'bg-violet-400/10 border-violet-400/20', hoverBorder: 'hover:border-violet-400/30' },
              { icon: CircleDollarSign, titleKey: 'landing.role_operator_title', bodyKey: 'landing.role_operator_body', iconColor: 'text-emerald-600 dark:text-emerald-300', iconBg: 'bg-emerald-400/10 border-emerald-400/20', hoverBorder: 'hover:border-emerald-400/30' },
              { icon: CalendarCheck2, titleKey: 'landing.role_teacher_title', bodyKey: 'landing.role_teacher_body', iconColor: 'text-blue-600 dark:text-blue-300', iconBg: 'bg-blue-400/10 border-blue-400/20', hoverBorder: 'hover:border-blue-400/30' },
            ] as const
          ).map((r) => {
            const Icon = r.icon;
            return (
